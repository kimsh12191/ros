...
class WordCountTestRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type WordCountTestRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type WordCountTestRequest
    let len;
    let data = new WordCountTestRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new WordCountTestRequest(null);
...
class WordCountTestResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type WordCountTestResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type WordCountTestResponse
    let len;
    let data = new WordCountTestResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new WordCountTestResponse(null);
...
module.exports = {
  Request: WordCountTestRequest,
  Response: WordCountTestResponse,
  md5sum() { return '58903d21a3264f3408d79ba79e9f7c7e'; },
  datatype() { return 'basics/WordCountTest'; }
};

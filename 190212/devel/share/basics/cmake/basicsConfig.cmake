...
if("TRUE" STREQUAL "TRUE")
  set(basics_SOURCE_PREFIX /home/suhyun/rosdir/190212/src/basics)
  set(basics_DEVEL_PREFIX /home/suhyun/rosdir/190212/devel)
  set(basics_INSTALL_PREFIX "")
  set(basics_PREFIX ${basics_DEVEL_PREFIX})
else()
  set(basics_SOURCE_PREFIX "")
  set(basics_DEVEL_PREFIX "")
  set(basics_INSTALL_PREFIX /home/suhyun/rosdir/190212/install)
...
if(NOT "/home/suhyun/rosdir/190212/devel/include " STREQUAL " ")
  set(basics_INCLUDE_DIRS "")
  set(_include_dirs "/home/suhyun/rosdir/190212/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'suhyun <suhyun@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/suhyun/rosdir/190212/src/basics/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/suhyun/rosdir/190212/devel/lib;/opt/ros/kinetic/lib)
